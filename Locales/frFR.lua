...
--@localization(locale="frFR", format="lua_additive_table", namespace="TradeSkillUIImproved", handle-subnamespaces="none")@
...
--~ L["Change the color in the bag."] = "Change la couleur dans les sacs."
--~ L["Change the color in the bank."] = "Change la couleur dans la banque."
--~ L["Change the color of an icon if an item in the bag is already learned.\n\nA reload is necessary."] = "Change la couleur de l'icône si un item dans les sacs est déjà connu.\n\nUn rechargement de l'interface est nécessaire."
--~ L["Change the color of an icon if an item in the bank is already learned.\n\nA reload is necessary."] = "Change la couleur de l'icône si un item dans la banque est déjà connu.\n\nUn rechargement de l'interface est nécessaire."
--~ L["Change the color of an icon if the item (merchant, auction, bag, bank) is already learned.\n\nA reload is necessary."] = "Change la couleur de l'icône (Marchant, Hôtel de vente, Sac, Banque de guilde) si l'objet est déjà appris.\n\nUn rechargement est nécessaire."
